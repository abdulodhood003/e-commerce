    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className=' text-gray-500'>628204 Thalambur <br/>Chennai,Tamilnadu,INDIA</p> 
          <p className='text-gray-500'>Phone: (+91) 9042487567 <br/>Email:abdulodudood@gmail.com</p>
